...
public class SmartPointerEventContainer : MonoBehaviour,
ISelectHandler, IDeselectHandler, IPointerEnterHandler, IPointerExitHandler, ISubmitHandler, IPointerClickHandler
{
    ...
    public System.Func< System.Action > MaybeGetOnSubmit;
    public System.Action OnSelectCallback;
    public System.Action OnDeselectCallback;

    public bool affectedByNavigation => (MaybeGetOnSubmit?.Invoke())!=null;
    ...
    public void OnSubmit(BaseEventData data){
        ...
        MaybeGetOnSubmit?.Invoke()?.Invoke();
    }
